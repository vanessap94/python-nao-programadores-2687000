...
def percorre_curso (curso_selecionado):
  ...
  print(
    f'Bem vinda ao curso "{curso_atual}"!. Você está iniciando o curso nível {curso_nivel_atual}.\n...)
...
print(
f'Parabéns! Você acaba dede finalizar a fase {curso_nivel_atual} do curso "{curso_atual}".')
curso_nivel_atual +=1
else:
